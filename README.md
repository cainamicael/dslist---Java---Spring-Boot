...
O dslist consiste em uma api que retorna games, listas de games e games ordenados por listas e tem um bônus
Há também um endpoint especial para posicionamento na lista de um determinado game. Aprendi muito com este intensivão,
e aqui em baixo, tem mais detalhes deste projeto!
...
Aprendi muito sobre o Spring Boot, perfis de projeto, docker e mais outras coisas

## Modelo de domínio DSList

![Modelo de domínio DSList](https://raw.githubusercontent.com/devsuperior/java-spring-dslist/main/resources/dslist-model.png)

## Consultas personalizadas usadas:
...
### Seeding do nosso banco de dados:
...
### Script Docker Compose, usado para o perfil de desenvolvimento:
